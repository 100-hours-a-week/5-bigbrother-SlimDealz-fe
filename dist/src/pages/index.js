...
const OutLetContainer = () => {
    ...
    return (_jsxs("div", { style: { backgroundColor: '#f9f9f9' }, children: [_jsx(Header, { pageTitle: pageTitle }), _jsx(styles.Container, { "$paddingTop": height, children: _jsx(Outlet, {}) }), _jsx(Footer, {})] }));
};
